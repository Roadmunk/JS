...
define(function(require, exports, module) {	// eslint-disable-line no-unused-vars
	 ...
	 */
	exports.callback = function callback(func, args, context) {
	 ...
	 * @return {Object}
	 */
	exports.defaults = function defaults(object, defaultValues) {
		if (!object) {
	 ...
	 * @return {Function}
 	*/
	exports.createFactory = function createFactory(constructor) {
		return function() {
	 ...
	 */
	exports.proxy = function proxy(object, property, newFunction) {
